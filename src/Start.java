...
if (sc.hasNextInt()) {
    ...
    if (inputNum >= 1 && inputNum <= 3) {
        ...
        if(inputNum == 1){
            ...
            /**
             *  Японял! Нужно просто в метод декодера передать метод с перебором ключей fori и декодить
             *  каждый раз при возрастании ключа в данной программе ограничение ввода 1-25, надо проверить
             * **/
